...
public class TypeNameExtractorReplaced extends TypeNameExtractor {
    ...
    public TypeNameExtractorReplaced(TypeResolver typeResolver, PluginRegistry<TypeNameProviderPlugin, DocumentationType> typeNameProviders, EnumTypeDeterminer enumTypeDeterminer) {
